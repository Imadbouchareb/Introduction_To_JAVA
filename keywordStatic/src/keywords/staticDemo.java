...
public class staticDemo {
	...
	public void display() {
		System.out.println("The value of static variable: " + staticVar);//display the value of static value
		System.out.println("The value of non-static variable: " + var);//display the value of non-static value
		System.out.println();
	}
}
